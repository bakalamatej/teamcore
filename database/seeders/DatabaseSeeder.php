...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $userPeter = User::factory()->create([
            'email' => 'peter@example.com',
            'password_hash' => 'password',
            'is_admin' => false
        ]);
        $userLucia = User::factory()->create([
            'email' => 'lucia@example.com',
            'password_hash' => 'password',
            'is_admin' => false
        ]);
        $userMartin = User::factory()->create([
            'email' => 'martin@example.com',
            'password_hash' => 'password',
            'is_admin' => false
        ]);
        $userKarol = User::factory()->create([
            'email' => 'karol@example.com',
            'password_hash' => 'password',
            'is_admin' => false
        ]);
        $userCoach2 = User::factory()->create([
        ...
        // Event types
        // -----------------------
        $typeTraining = EventType::create([
            'name' => 'Training',
            'sport_id' => $sportFootball->sport_id
        ]);
        $typeMatch = EventType::create([
            'name' => 'Match',
            'sport_id' => $sportFootball->sport_id
        ]);
        $typeTournament = EventType::create([
            'name' => 'Tournament',
            'sport_id' => $sportFootball->sport_id
        ]);
        $typeBbTraining = EventType::create([
            'name' => 'Training',
            'sport_id' => $sportBasketball->sport_id
        ]);
        $typeBbMatch = EventType::create([
            'name' => 'Match',
            'sport_id' => $sportBasketball->sport_id
        ]);
        ...
        foreach ([$eventFinished2, $eventScheduled2, $eventCanceled] as $ev) {
            EventClub::create([
                'event_id' => $ev->event_id,
                'club_id' => $club1->club_id
            ]);
        ...
        $file1 = File::create([
            ...
            'file_path' => 'files/event_photo.jpg',
            'file_type' => 'image/jpeg',
            'file_size' => 2048576,
            'uploaded_by_user_id' => $userAdmin->user_id
        ]);

        $file2 = File::create([
            'file_name' => 'club_document.pdf',
            'file_path' => 'files/club_document.pdf',
            'file_type' => 'application/pdf',
            'file_size' => 1024000,
            'uploaded_by_user_id' => $userAdmin->user_id
        ]);

        $club1->clubFiles()->attach($file2->file_id, [
            'file_category_id' => $catDocument->file_category_id
        ]);
        $club2->clubFiles()->attach($file1->file_id, [
            'file_category_id' => $catPhoto->file_category_id
        ]);
        $eventFinished1->eventFiles()->attach($file1->file_id, [
            'file_category_id' => $catPhoto->file_category_id
        ]);
        $eventScheduled1->eventFiles()->attach($file2->file_id, [
            'file_category_id' => $catDocument->file_category_id
        ]);
        $mc1->memberClubFiles()->attach($file1->file_id, [
            'file_category_id' => $catDocument->file_category_id
        ]);
        ...
        foreach ($evaluations as [$coachMcId, $evaluatedById, $rating, $comment]) {
            CoachEvaluation::create([
                'coach_member_club_id' => $coachMcId,
