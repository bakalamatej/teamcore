    ...
    <div class="flex min-h-[calc(100vh-11rem)]">
        ...
        <main class="flex-1 pl-0 xl:pl-[280px]">
            <div class="mx-auto bg-white overflow-hidden shadow-xl rounded-lg p-4 sm:p-8">
                ...
                <form method="POST" action="{{ route('panel.reservations.update', $reservation) }}" class="space-y-6">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="flex flex-col lg:flex-row gap-6">
                        ...
                        <div>
                            ...
                            <x-select-input
                                ...
                                :selected="old('sport_id', $reservation->sport_id)"
                        ...
                        <div>
                            ...
                            <x-select-input
                                ...
                                name="club_id"
                                :options="$clubOptions"
                                :selected="old('club_id', $reservation->club_id)"
                        ...
                        <div>
                            ...
                            <x-select-input
                                ...
                                :selected="old('created_by_member_club_id', $reservation->created_by_member_club_id)"
