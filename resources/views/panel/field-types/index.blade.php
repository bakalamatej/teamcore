        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-sm text-gray-600">{{ $fieldTypes->total() }} {{ __('field types total') }}</span>
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                    <form id="filter-form" method="GET" action="{{ route('panel.field-types.index') }}" class="flex flex-col sm:flex-row gap-4 flex-wrap">
                        <div class="flex-1">
                        ...
                        <div class="flex items-end justify-end">
                            <x-add-button href="{{ route('panel.field-types.create') }}" class="!h-9" />
                        </div>
                    </form>
                </div>

                <div id="results">
                    @include('panel.field-types._table', compact('fieldTypes'))
                </div>
            </div>
        </main>
    </div>
