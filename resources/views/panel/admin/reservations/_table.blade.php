<div class="border border-gray-300 rounded-md overflow-hidden shadow-md overflow-x-auto">
            ...
            @forelse($reservations as $reservation)
                <tr class="border-b hover:bg-gray-50 data-row">
                    ...
                    <td class="p-3 text-right">
                        <a href="{{ route('panel.admin.reservations.show', $reservation) }}" class="table-action view mr-2">
                            {{ __('View') }}
                        </a>

                        <a href="{{ route('panel.admin.reservations.edit', $reservation) }}" class="table-action edit mr-2">
                            {{ __('Edit') }}
                        </a>
