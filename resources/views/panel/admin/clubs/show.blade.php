        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            @foreach($recentEvents as $event)
                                <div class="detail-list-item" style="display: block;">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <a href="{{ route('panel.admin.events.show', $event) }}" class="detail-list-item-link">
                                                {{ $event->title }}
                                            </a>
            ...
            <div class="lg:col-span-1 flex flex-col">
                ...
                <div class="space-y-3 mt-auto">
                    @auth
                        @if($canManageClub)
                            <x-primary-button class="w-full justify-center" :href="route('panel.admin.clubs.edit', $club)">
                                {{ __('Edit Club') }}
                            </x-primary-button>
                            ...
                            <x-modal name="confirm-club-deletion-{{ $club->id }}" :show="false" focusable>
                                <form method="POST" action="{{ route('panel.admin.clubs.destroy', $club) }}" class="p-6 text-left">
                                    @csrf
                                    @method('DELETE')
