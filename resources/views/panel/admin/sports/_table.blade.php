            ...
            @forelse($sports as $sport)
                <tr class="border-b hover:bg-gray-50 data-row">
                    ...
                    <td class="p-3 text-right">
                        <a href="{{ route('panel.admin.sports.edit', $sport) }}" class="table-action edit mr-2">
                            {{ __('Edit') }}
                        </a>
                        ...
                        <x-modal name="confirm-sport-deletion-{{ $sport->sport_id }}" :show="false" focusable>
                            <form method="POST" action="{{ route('panel.admin.sports.destroy', $sport) }}" class="p-6 text-left">
                                @csrf
                                @method('DELETE')
