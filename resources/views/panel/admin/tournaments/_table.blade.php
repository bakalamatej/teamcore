            ...
            @forelse($tournaments as $tournament)
                <tr class="border-b hover:bg-gray-50 data-row">
                    ...
                    <td class="p-3 text-right">
                        <a href="{{ route('panel.admin.tournaments.show', $tournament) }}" class="table-action view mr-2">{{ __('View') }}</a>
                        <a href="{{ route('panel.admin.tournaments.edit', $tournament) }}" class="table-action edit mr-2">{{ __('Edit') }}</a>
