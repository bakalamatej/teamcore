<x-panel-layout>
    <div class="bg-white overflow-hidden shadow-xl rounded-lg sm:p-8">
        ...
        <form action="{{ route('panel.admin.tournaments.children.store', $tournament) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="flex gap-4 mt-4">
                ...
                <x-danger-button :href="route('panel.admin.tournaments.show', $tournament)">{{ __('Discard') }}</x-danger-button>
            </div>
        </form>
    </div>
</x-panel-layout>